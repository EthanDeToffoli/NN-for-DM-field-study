...
from modelCNN import LogNormalDataset, SimpleCNN, CosmoVGG, CosmoGoogLeNet, CosmoResNet, CosmoResNet3head
...
def main():
    ...
    dataset_completo = LogNormalDataset(PERCORSO_X, PERCORSO_Y)
